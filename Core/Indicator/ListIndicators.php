...
<br>
	...
	<ul>
		<li><a href="NewClassForm.php" TARGET='homes'>Indiocator Class </a></li>
		<li><a href="NewIndicatorForm.php" TARGET='homes'>Indicator</a></li>
	</ul></li>
<br/>
...
while ($data = mysql_fetch_array ($sql ) ){
       $classname = $data['ClassName'] ; //$nom = $mysqlf['nom'] ; 
        ...
        echo "<td><a href=LoadClass.php?cn=".$classname." TARGET='homes'><img src=temps/eye.png></a><td>" ;
        echo "<td> <a href=ManageIndicator.php?cn=".$classname."&pm=7 TARGET='homes'><img src=temps/d2.png></a></td>"; 
        
        echo " </tr>";
        echo "</table>";
            
            // ensuite sa transformation
            $requette="select iname from indicator where iclass='".$classname."'";
            ...
            while ($data2 = mysql_fetch_array ($sql2) ) {
                ...
                echo "        </div>";
                echo "    </td>";
                 echo "    <td><a href=LoadIndicator.php?cn=".$name." TARGET='homes'><img src=temps/eye2.png></a><td>" ;
                echo "    <td><a href=ManageIndicator.php?cn=".$name."&class=".$group."&pm=5 TARGET='homes'><img src=temps/d2.png></a></td>"; 
