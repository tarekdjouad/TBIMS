...
while  ($data = mysql_fetch_array ($sql ) ){
        ...
        echo "<td><a href=ManageMenue.php?pm=10&cname=".$classname." TARGET='homes'><img src=temps/eye.png></a><td>" ;
        echo "<td> <a href=ManageMenue.php?pm=13&cname=".$classname." TARGET='homes'><img src=temps/d2.png></a></td>"; 
        ...
        echo "</table>";
            ...
            while ($data2 = mysql_fetch_array ($sql2) ) {
                ...
                echo "        </div>";
                echo "    </td>";
                 echo "    <td><a href=ManageMenue.php?pm=11&tname=".$name." TARGET='homes'><img src=temps/eye2.png></a><td>" ;
                echo "    <td><a href=ManageMenue.php?pm=12&tname=".$name." TARGET='homes'><img src=temps/d2.png></a></td>"; 
